            ...
            <div className="mt-8 p-6 bg-white rounded-lg shadow-sm border border-slate-200">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="min-w-[140px] px-4 py-3 bg-green-500 hover:bg-green-600 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-1"
                >
                  <span>👍</span>
                  <span>도움이 됨</span>
                </button>
                ...
                <button
                  ...
                  className="min-w-[140px] px-4 py-3 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-1"
                >
                  <span>👎</span>
                  <span>부족함</span>
                </button>
